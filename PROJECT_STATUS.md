...
```
仓库名：lobster-app
描述：🦞 能虾助手 - 移动端 AI 智能助手，能真正干活的通用 Agent
可见性：Public (公开)
主分支：main
提交数：1
文件数：6
...
|------|------|--------|
| 国内云服务器部署 | ⏳ 待开始 | Eric |
| OpenClaw 国内适配 | ⏳ 待开始 | 能虾助手 |
| 通义千问 API 对接 | ⏳ 待开始 | 能虾助手 |
| 智谱 GLM API 对接 | ⏳ 待开始 | 能虾助手 |
| 百度/360 搜索对接 | ⏳ 待开始 | 能虾助手 |
| 多租户用户系统 | ⏳ 待开始 | 能虾助手 |
